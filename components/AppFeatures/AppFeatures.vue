      ...
      items: [
        {
          ...
          tooltip: {
            text: 'Накопления формировались с&nbsp;2002 по&nbsp;2013 гг. Теперь их&nbsp;можно перевести на&nbsp;счёт и&nbsp;сделать частью ваших сбережений',
            icon: '24/info-filled',
            iconTheme: 'white-filled'
          },
          image: {
            alt: 'Пенсионные накопления (ОПС) в ваших руках',
            src: 'images/features/image-7.png'
          },
          action: {
            title: 'Узнать',
            text: 'Узнать',
        ...
        },
        {
          ...
          text: 'Государство увеличит ваши сбережения. Получайте ежегодно до 36 000 ₽ в первые 10 лет. Софинансирование ограничено 36&nbsp;000&nbsp;Р/год на одного вкладчика и&nbsp;не&nbsp;зависит от количества открытых договоров ПДС.',
          image: {
          ...
          tooltip: {
            icon: '24/info-filled',
            iconTheme: 'white-filled',
            text: 'Сумма поддержки зависит от вашего официального дохода. Если зарабатываете до 80 000 ₽ / мес, вносите ежемесячно от 3 000 ₽ и&nbsp;получайте дополнительно до&nbsp;36&nbsp;000&nbsp;₽ за год от&nbsp;государства. Для&nbsp;софинансирования требуется уплата не менее 2 000 руб. личных взносов.'
          }
        },
        {
          title: 'Счет застрахован в АСВ',
          text: 'Агентство по страхованию вкладов защитит ваши личные сбережения на сумму до&nbsp;2,8&nbsp;млн&nbsp;₽. А на&nbsp;софинансирование от&nbsp;государства и&nbsp;единовременный взнос в&nbsp;виде пенсионных накоплений, которые переведены на&nbsp;счёт ПДС, действует дополнительная страховка',
          image: {
