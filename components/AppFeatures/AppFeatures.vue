    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          text: 'Агентство по страхованию вкладов защитит ваши личные сбережения на&nbsp;сумму до 2,8 млн Р, а также софинансрование от государства и сумму накопительной пенсии',
          image: {
        ...
        },
        {
          ...
          tooltip: {
            text: 'Указанный размер определен на&nbsp;основании информации Минфина России и устанавливается Федеральным законом о&nbsp;внесении изменений в Налоговый кодекс (на&nbsp;18.12.2023г.). Законопроект одобрен Государственной Думой РФ в&nbsp;1&nbsp;чтении.',
            icon: '24/info-filled',
            iconTheme: 'white-filled'
          },
          image: {
