    ...
    return {
      ...
      rows: [
        ...
        },
        {
          ...
          text: 'Сначала переведите пенсионные накопления в СберНПФ не позднее 15 ноября 2024г. Это позволит уже в 2025 году подать заявление на&nbsp;перевод накоплений в программу',
          tooltip: {
