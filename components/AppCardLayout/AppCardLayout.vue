      ...
      items: [
        {
          ...
          icon: '80/rub',
          text: 'Получить её можно через 15&nbsp;лет&nbsp;после того, как вступили в&nbsp;программу.',
          tooltip: {
            text: 'Или по достижению 55 лет для женщин и 60 лет для мужчин, если при расчете пожизненной выплаты размер ежемесячной выплаты будет менее 10% прожиточного минимума пенсионера',
            icon: '24/info-stroke'
          }
        },
        {
